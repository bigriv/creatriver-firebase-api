...
app.get("/edits/games/was/talk", (req, res) => editWasTalkController.get(req, res));
app.post("/edits/games/was/talk", (req, res) => editWasTalkController.post(req, res));
app.delete("/edits/games/was/talk/:id", (req, res) => editWasTalkController.delete(req, res));

const editWasBattleController = new EditWasBattleController(
  new WasBattleRepository(bucket)
);
app.get("/edits/games/was/battle", (req, res) => editWasBattleController.get(req, res));
app.post("/edits/games/was/battle", (req, res) => editWasBattleController.post(req, res));
app.delete("/edits/games/was/battle/:id", (req, res) => editWasBattleController.delete(req, res));
